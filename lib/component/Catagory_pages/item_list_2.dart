...
class ItemList_2 extends StatefulWidget {
  @override
  State<ItemList_2> createState() => _ItemList_2State();
}

class _ItemList_2State extends State<ItemList_2> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          store.getPizza(messages);

          List<ItemCard> messageBubbles = [];
          for (var ab = 0; ab < store.Pizza.length; ab++) {
            for (var message in store.Pizza[ab]) {
